...
function Person(individual) {
	...
	this.hobby = function() {
		let hobby = individual['hobby'] || '活着';
		console.info(this.name + '的爱好是' + hobby + ';');
		return this;
	}
	this.runs = function() {
		let runs = individual['runs'] || '梦想';
		console.info(this.name + '他为' + runs + '活着;')
	}
	this.bri = function() {
		let bri = individual['bri'] || '我们尚未知道他/她何时来到这个世界';
		console.info('生日是： ' + bri);
	}
